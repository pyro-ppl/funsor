...
from funsor import __version__
...
# Branch/tag for GitHub and Colab links. On Read the Docs, prefer the checked-out
# git ref; PR builds set READTHEDOCS_GIT_IDENTIFIER to a numeric ID, so fall back
# to the commit hash which GitHub/Colab can resolve.
_github_version = os.environ.get("READTHEDOCS_GIT_IDENTIFIER", "master")
if _github_version.isdigit():
    _github_version = os.environ.get("READTHEDOCS_GIT_COMMIT_HASH", "master")
html_context = {"github_version": _github_version}
...
autodoc_default_options = {
    ...
    # Sphinx 9 crashes on `special-members: True` with some annotated APIs;
    # document constructors explicitly instead.
...
:github_url: https://github.com/pyro-ppl/funsor/blob/{{ env.config.html_context.github_version }}/{{ docname }}
...
latex_documents = [
    (root_doc, "Funsor.tex", "Funsor Documentation", "Uber AI Labs", "manual")
]
...
man_pages = [(root_doc, "Funsor", "Funsor Documentation", [author], 1)]
