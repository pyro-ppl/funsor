...
def test_use_funsor_interally_2():
    def gaussian_log_prob(info_vec, prec_sqrt, value):
        # Convert backend arrays -> to funsors.
        g = Gaussian(info_vec, prec_sqrt, OrderedDict(x=Reals[3]))
    ...
    prec_sqrt = randn(3, 3)
    data = dict(info_vec=randn(3), prec_sqrt=prec_sqrt, value=randn(3))
