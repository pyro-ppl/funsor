...
def test_beta_density(batch_shape, eager):
    ...
    @funsor.tensor.function(reals(), reals(), reals(), reals())
...
def test_bernoulli_probs_density(batch_shape, syntax):
    ...
    @funsor.tensor.function(reals(), reals(), reals())
...
def test_delta_density(batch_shape, event_shape):
    ...
    @funsor.tensor.function(reals(*event_shape), reals(), reals(*event_shape), reals())
...
def test_dirichlet_density(batch_shape, event_shape):
    ...
    @funsor.tensor.function(reals(*event_shape), reals(*event_shape), reals())
...
def test_multinomial_density(batch_shape, event_shape):
    ...
    @funsor.tensor.function(reals(), reals(*event_shape), reals(*event_shape), reals())
...
def test_mvn_density(batch_shape):
    ...
    @funsor.tensor.function(reals(3), reals(3, 3), reals(3), reals())
